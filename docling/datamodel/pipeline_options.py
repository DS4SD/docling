...
class RapidOcrOptions(OcrOptions):
    ...
    lang: List[str] = ["english", "chinese"] # However, language as a parameter is not supported by rapidocr yet and hence changing this options doesn't affect anything. 
